...
using MovieSerenity.Modules.Administration.Genre.Genre.RequestHandlers;
using Serenity.Data;
...
[Route("Services/Adminstraion/Genre/[action]")]
...
public class GenreEndpoint : ServiceEndpoint
{
        ...
        [FromServices] IExcelExporter exporter)
    {
        ...
        var bytes = exporter.Export(data, typeof(GenreColumns), request.ExportColumns);
