using MyRepository = MovieSerenity.Administration.Repositories.UserPermissionRepository;
using MyRow = MovieSerenity.Administration.UserPermissionRow;

namespace MovieSerenity.Administration.Endpoints;
