...
public sealed class MovieGenresRow : Row<MovieGenresRow.RowFields>, IIdRow
{
    ...
    [DisplayName("Genre"), NotNull, ForeignKey(typeof(Modules.Administration.Genre.Genre.GenreRow)), LeftJoin(jGenre)]
    [TextualField(nameof(GenreName)), LookupEditor(typeof(Modules.Administration.Genre.Genre.GenreRow), Async = true)]
    ...
    [DisplayName("Genre Name"), Origin(jGenre, nameof(Modules.Administration.Genre.Genre.GenreRow.Name))]
